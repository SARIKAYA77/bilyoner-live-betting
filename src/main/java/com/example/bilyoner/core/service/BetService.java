...
public interface BetService {
     ...
     */
    CompletableFuture<Bet> placeBetAsync(Long eventId, Long customerId, Bet.BetType betType, Integer multipleCount, Double stakeAmount);
    
    /**
     * Places a bet synchronously
     * Includes validation for multiple count and stake limits
     */
    Bet placeBet(Long eventId, Long customerId, Bet.BetType betType, Integer multipleCount, Double stakeAmount);
